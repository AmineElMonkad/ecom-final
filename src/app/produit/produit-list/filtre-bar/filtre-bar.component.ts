...
export class FiltreBarComponent implements OnInit {
  ...
  drag() {
    ...
    console.log(this.minMaxPrix[0]);
    console.log(this.minMaxPrix[1]);
    console.log(this.selectedPrix);
  }
  ...
  setMaxPrice() {
    this.selectedPrix = this.minMaxPrix[1];
    this.drag();
  }

  setMinPrice() {
    this.selectedPrix = this.minMaxPrix[0];
    this.drag();
  }
